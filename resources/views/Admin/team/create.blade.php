...
@section('content')
    <div class="container mx-auto px-4 sm:px-8">
        <div class="py-8">
            <h2 class="text-2xl font-semibold leading-tight mb-6">Add New Team Member</h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="mb-4">
                            ...
                            <input
                                ...
                                id="github_link" type="url" name="github_link" value="{{ old('github_link') }}">
                        </div>
                        <div class="mb-4">
                            ...
                            <input
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                id="linkedin_link" type="url" name="linkedin_link" value="{{ old('linkedin_link') }}">
                        </div>
                        <div class="mb-4">
                            ...
                            <input
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                id="instagram_link" type="url" name="instagram_link" value="{{ old('instagram_link') }}">
                        </div>
                        <div class="mb-4">
                            ...
                            <input
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                id="twitter_link" type="url" name="twitter_link" value="{{ old('twitter_link') }}">
                        </div>
                        <div class="mb-4">
                            ...
                            <input
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                id="dribbble_link" type="url" name="dribbble_link" value="{{ old('dribbble_link') }}">
                        </div>
                    </div>
