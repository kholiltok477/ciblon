...
@section('content')
    <div class="max-w-4xl mx-auto">
        <div class="mb-6 flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-gray-800">Create Competition</h2>
                <p class="text-gray-500 text-sm">Organize a new official swimming event.</p>
            </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title') }}" required
                            ...
                            placeholder="e.g. Turnamen Renang Pelajar Regional">
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="location" id="location" value="{{ old('location') }}" required
                                class="w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-all"
                                placeholder="e.g. Kolam Renang Mangli">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="5" required
                            class="w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-all">{{ old('description') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <div
                            ...
                            <div class="space-y-1 text-center font-medium">
                                ...
                                <p class="text-xs text-gray-500">Landscape recommended (PNG, JPG)</p>
                            </div>
                        </div>
                    </div>
