...
@section('content')
    <div class="max-w-4xl mx-auto">
        <div class="mb-6 flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-gray-800">Create News Article</h2>
                <p class="text-gray-500 text-sm">Draft a new story for your visitors.</p>
            </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title') }}" required
                            ...
                            placeholder="e.g. Pembukaan Lomba Renang 2025">
                        @error('title')
                    ...
                    <div>
                        ...
                        <textarea name="content" id="content" rows="10" required
                            class="w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-all">{{ old('content') }}</textarea>
                        @error('content')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="pt-6 border-t border-gray-100 flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <label for="is_published"
                                class="ml-3 text-sm font-bold text-gray-900 uppercase tracking-widest">Publish
                                Immediately</label>
                        </div>
