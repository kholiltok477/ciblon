    ...
    <div class="max-w-2xl mx-auto">
        <div class="mb-6 flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-500 text-sm">Update user details and access control.</p>
            </div>
            ...
            <form action="{{ route('admin.users.update', $user) }}" method="POST">
                ...
                <div class="space-y-6">
                    ...
                    <div class="pt-4 border-t border-gray-100">
                        <p class="text-xs text-gray-500 mb-4 font-semibold uppercase tracking-wider">Change Password (Leave
